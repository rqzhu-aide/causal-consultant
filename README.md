...
`project_state.yaml`, applies a compact `next_step_plan`, loads the planned
route reference, and then loads `team_lead` as the final manager.
...
Version 4.3.0 uses a compact route-reference architecture: one state file at
