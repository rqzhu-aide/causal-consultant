...
| Missing outcome rate by arm | Differential attrition threatens interpretation | Activate `16`; sensitivity/bounds/IPW/imputation |
...
| Compliance/exposure table | Assignment may not equal treatment received | ITT primary; activate `09` for CACE/LATE |
...
| Interference screen | SUTVA may fail | Activate `13`; exposure mapping |
...
- CACE/LATE needs IV assumptions and routes to subskill 09.
