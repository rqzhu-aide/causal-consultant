...
- `implications.data_technician_02`: Data Technician checks for data elements, row structures, timestamps, IDs, diagnostics, or method feasibility needed for design execution.
...
- route_id: "route-01"
  ...
  recommended_next_action: "ask_user | inspect_data | refresh_domain_helper_01 | refresh_data_technician_02 | refresh_dag_builder_04 | confirm_analysis_plan | activate_method_subskill | run_first_pass | run_diagnostics | prepare_final_report | proceed_with_caveat | block_ready_gate | mark_ready | no_action | unknown"
```
...
9. Route implications to Domain Helper, the Data Technician, or DAG Builder; do not edit their sections directly.
