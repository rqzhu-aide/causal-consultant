...
| Finding | Route |
|---|---|
| Treatment randomized | `01-randomized-experiments` |
| Treatment varies over time | `06-longitudinal-gmethods` |
| Unmeasured confounding with credible instrument | `09-instrumental-variables` |
| Policy timing with pre/post panel | `07-did-event-study` |
| Cutoff assignment | `08-regression-discontinuity` |
| Survival/censoring/competing risks outcome | `11-survival-competing-risks` after baseline design |
| Interference/spillovers | `13-interference-spillovers` |
| Severe missingness, measurement error, selection | `16-missingness-measurement-selection` |
| Final estimator is AIPW/TMLE/DML | `04-doubly-robust-ml` after balance design |
...
If a large number of units are dropped due to missing covariates, route to missingness methods or report a complete-case target population.
