...
- `implications.data_inspector_02`: data/timing variables that must be verified before analytic implementation.
...
- hypothesis_id: "logic-01"
  ...
  design_implications: []
  method_handoff: []
  recommended_next_action: "ask_user | inspect_data | refresh_domain_helper_01 | refresh_data_inspector_02 | refresh_design_planner_03 | proceed_with_caveat | block_ready_gate | mark_ready | no_action | unknown"
```
...
1. Read `main_skill`, `foundation_gate`, `evaluator_loop`, `routes`, `evaluators.design_planner_03`, `evaluators.domain_helper_01`, and `evaluators.data_inspector_02`.
...
4. Audit Domain Helper's `candidate_formulations` and Data Inspector's `data_enabled_opportunities` for coherent causal timing, roles, mechanisms, and assumptions.
...
9. Record implications for Domain Helper, Design Planner, Data Inspector, and method subskills; do not edit their sections directly.
