---
name: design-planner
description: Use when the user has no data yet or wants to design a future study, experiment, quasi-experiment, rollout, registry, survey, cohort, or data collection plan for causal analysis.
version: 0.1.0
---
