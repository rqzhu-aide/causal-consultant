...
Also read `subskills/01-randomized-experiments/`.
...
Also read `subskills/08-regression-discontinuity/`.
...
Also read `subskills/05-heterogeneous-effects-policy/`.
...
- `subskills/09-instrumental-variables/examples/r_ivreg_diagnostics.R`
- `subskills/09-instrumental-variables/examples/r_fixest_iv.R`
- `subskills/09-instrumental-variables/examples/python_linearmodels_iv.py`
- `subskills/09-instrumental-variables/examples/python_doubleml_iv.py`
- `subskills/09-instrumental-variables/examples/r_late_characterization.R`
