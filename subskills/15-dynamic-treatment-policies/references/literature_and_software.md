...
# Define ordered histories, feasible actions, and value before choosing an estimator.
history <- build_history(long_data, id = "id", time = "time",
                         actions = c("A1", "A2"),
                         covariates = list(c("L1"), c("L2")))
