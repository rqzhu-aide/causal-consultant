# causal_discovery_skill (merged into subskill 14)
...
- `references/discovery_references.md`: source links.
...
This content was merged from the standalone `causal_discovery_skill` package to enrich subskill 14.
