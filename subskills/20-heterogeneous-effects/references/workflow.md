...
If the user wants a decision rule or prioritization, route to `21-point-treatment-rules`. If the modifier is a mediator or post-treatment pathway variable, route to `22-mediation` or another valid post-treatment target before estimating.
...
- Longitudinal treatment: ask `09-longitudinal-gmethods`; effect modifiers may be baseline or history-dependent depending on the estimand.
...
- Survival outcomes: keep this target active, but ask `33-survival-competing-risks` for censoring, time scale, and effect measure.
...
| Policy implication | Heterogeneity plus `21-point-treatment-rules` | Converts effect variation into decision logic | CATE alone ignores costs, harms, and constraints |
