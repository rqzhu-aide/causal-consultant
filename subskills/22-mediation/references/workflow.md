...
If the mediator is really a baseline subgroup, use `20-heterogeneous-effects`. If the user wants a future adaptive strategy, coordinate with `25-dynamic-treatment-policies`.
...
- Survival/competing risk outcome: ask `33-survival-competing-risks`; product-of-coefficients intuition often fails.
