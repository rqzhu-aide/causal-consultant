...
- `method_lead`: design route, estimand set, assumptions, DAG/theory, positivity plan, sensitivity plan, and wording boundary.
...
- `subskill_id`: `23-dose-response-effects`
