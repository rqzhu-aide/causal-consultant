...
- Need longitudinal treatment/censoring weights: coordinate with `09-longitudinal-gmethods`.
- Need final effect estimation with robustness: pass balance/weight artifacts to `31-doubly-robust-estimation`.
