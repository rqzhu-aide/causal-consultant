...
| Heterogeneous effects | Causal forest, orthogonal forest, R-learner/DR-learner | CATE support with honesty/orthogonality | Needs `20-heterogeneous-effects` target and diagnostics |
...
| IV with high-dimensional controls | DML IV/PLIV | Orthogonal IV score | Needs `12-instrumental-variables` assumptions |
...
- `31-doubly-robust-estimation`: AIPW/TMLE/DR target and influence-function reporting.
- `30-matching-weighting-balance`: overlap, propensity, balance, and support checks.
- `20-heterogeneous-effects`: CATE/forest/learner target and reporting.
- `21-point-treatment-rules`: policy scores and rule-learning support.
- `09-longitudinal-gmethods`: time-varying histories and sequential assumptions.
- `12-instrumental-variables`: IV-DML assumptions and first-stage diagnostics.
- `33-survival-competing-risks`: censored outcomes and survival targets.
